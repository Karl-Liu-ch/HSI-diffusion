...
import scipy.io
import re
from ldm.data.data_augmentation import split_train, split_valid, split_test, split_full_test
# from utils import *
from omegaconf import OmegaConf
config_path = "configs/autoencoder/hsi_autoencoder_kl.yaml"
...
class GetDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        ex["image"] = np.ascontiguousarray(hyper)
