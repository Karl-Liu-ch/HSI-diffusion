...
#BSUB -o sstransformer%J.out
#BSUB -e sstransformer%J.err
# -- end of LSF options --
nvidia-smi
...
NCCL_P2P_DISABLE=1 python -u main.py -c configs/sst/sstransformer_lightning.yaml --gpu_id 0,1 --batch_size 14 --learning_rate 4e-4 --mode train