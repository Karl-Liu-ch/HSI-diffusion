...
NCCL_P2P_DISABLE=1 python -u main.py -c configs/ae_kl/hsi_vae_perceptual_cond_32.yaml -l $LOGDIR --end_epoch 500 --batch_size 48 --gpu_id $GPUID --mode train -r $CKPT
