...
### -- set the job Name --
#BSUB -J vae_perceptual_cond_2gpu
...
#BSUB -o vae_perceptual_cond_2gpu%J.out
#BSUB -e vae_perceptual_cond_2gpu%J.err
# -- end of LSF options --
nvidia-smi
...
NCCL_P2P_DISABLE=1 python -u main.py -c configs/ae_kl/hsi_vae_perceptual_cond.yaml -l $LOGDIR --end_epoch 500 --batch_size 32 --gpu_id $GPUID --in_channels 6 --mode train -r $CKPT
