...
#BSUB -o vae_perceptual-2gpu%J.out
#BSUB -e vae_perceptual-2gpu%J.err
# -- end of LSF options --
nvidia-smi
...
NCCL_P2P_DISABLE=1 python -u main.py -c configs/ae_kl/hsi_vae_perceptual.yaml -l $LOGDIR --end_epoch 500 --batch_size 28 --gpu_id $GPUID --in_channels 31 -r $CKPT
