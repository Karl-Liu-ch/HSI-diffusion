...
#BSUB -o vae_perceptual_cond%J.out
#BSUB -e vae_perceptual_cond%J.err
# -- end of LSF options --
nvidia-smi
...
python -u main.py -c configs/ae_kl/hsi_vae_perceptual_cond.yaml -l $LOGDIR --end_epoch 500 --batch_size 64 --gpu_id $GPUID --in_channels 6 --mode train
#  -r $CKPT