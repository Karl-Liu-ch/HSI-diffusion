...
ddconfig = cfg.model.first_stage.params.ddconfig
...
class TrainVQGAN:
    def __init__(self, args):
        ...
        # ckpt = torch.load(os.path.join("/work3/s212645/Spectral_Reconstruction/checkpoint/VQGAN/", f"vqgan_epoch_latest.pt"))
    ...
    def train(self, args):
        ...
        for epoch in range(args.epochs):
            with tqdm(range(len(train_dataset))) as pbar:
                for i, (x, imgs, _) in zip(pbar, train_dataset):
                    ...
                    perceptual_loss = 0
                    rec_loss = criterion_mrae(decoded_images, imgs) + criterion_rmse(decoded_images, imgs)
                    ...
                    pbar.update(0)
                print(epoch, rec_loss.item())
                torch.save(self.vqgan.state_dict(), os.path.join("/work3/s212645/Spectral_Reconstruction/checkpoint/VQGAN/", f"vqgan_epoch_latest.pt"))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--image-channels', type=int, default=31, help='Number of channels of images (default: 3)')
