...
if __name__ == '__main__':
    model = CSWinBlock(dim=31 * 2, num_heads=2, reso=128, mlp_ratio=4,
                qkv_bias=False, qk_scale=None, split_size=1,
                drop=0, attn_drop=0,
                drop_path=0, norm_layer=nn.LayerNorm)
    summary(model, (128 * 128, 31 * 2))
    model.patches_resolution = 64
    for attn in model.attns:
        attn.change_resol(64)

    summary(model, (64*64, 62))