...
class SpatialAttention(nn.Module):
    def __init__(self, in_channels, spatial_size):
        ...
        # self.norm = nn.LayerNorm(normalized_shape=[2, spatial_size, spatial_size])
    ...
    # def change_resol(self, new_res):
    #     self.spatial_size = new_res
    #     self.norm = nn.LayerNorm(normalized_shape=[2, new_res, new_res])
...
class AttentionBlock(nn.Module):
    def __init__(self, in_channels, spatial_size):
        ...
        # self.norm = nn.LayerNorm(normalized_shape=[in_channels, spatial_size, spatial_size])
    ...
    # def change_resol(self, new_res):
    #     self.spatial_size = new_res
    #     self.norm = nn.LayerNorm(normalized_shape=[self.in_channels, new_res, new_res])
...
class Residual(nn.Module):
    def __init__(self, input_spatial_size):
        ...
        self.first_layers = nn.Sequential(
            ...
            AttentionBlock(in_channels=512, spatial_size=input_spatial_size//8),
