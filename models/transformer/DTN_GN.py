...
class SpatialGate(nn.Module):
    ...
    def __init__(self, dim):
        ...
        self.conv = nn.Conv2d(dim, dim, kernel_size=3, stride=1, padding=1, groups=dim, bias=True) # DW Conv
...
class SGFN(nn.Module):
    ...
    def __init__(self, in_features, hidden_features=None, out_features=None, act_layer=nn.GELU, drop=0.):
        ...
        self.fc2 = nn.Linear(hidden_features//2, out_features, bias=True)
...
class DTN(nn.Module):
    def __init__(self, in_dim, 
        ...
        dim = out_dim
        self.embedding = nn.Conv2d(in_dim, dim, 3, 1, 1, bias=True)
        ...
        self.mapping = nn.Conv2d(dim, out_dim, 3, 1, 1, bias=True)
        self.apply(self._init_weights)
...
if __name__ == '__main__':
    ...
    load_from_plmodel(model, ckpt_path)
    summary(model, (6, 256, 256))