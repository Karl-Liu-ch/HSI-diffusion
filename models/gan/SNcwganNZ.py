...
from models.transformer.DTN_NZ import DTN
...
class SNCWGANNoNoise():
    def __init__(self, opt, multiGPU = False) -> None:
        ...
        self.lamda = 100
        self.lambdasam = 100
        self.root = '/work3/s212645/Spectral_Reconstruction/checkpoint/SNCWGANNoNoise_New/'
...
if __name__ == '__main__':
    ...
    spec = SNCWGANNoNoise(opt, multiGPU=opt.multigpu)
    if opt.loadmodel:
